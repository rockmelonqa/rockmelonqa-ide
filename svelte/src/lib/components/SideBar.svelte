...
<div class="side-bar h-screen bg-neutral-100">
    <div class="{$appState.activity == ActivityType.Files ? '' : 'hidden'} h-full overflow-auto">
        <FileExplorer />
    </div>
    <div class="p-4 {$appState.activity == ActivityType.Search ? '' : 'hidden'}">
        <Search />
    </div>
</div>
